...
const API_GET_GENERATIONS_URL = `https://app.meteron.ai/api/images/generations?status=completed&model=${MODEL}&pageSize=200`
const API_GENERATE_URL = `https://app.meteron.ai/api/images/generations?model=${MODEL}`
